<template>
	...
	<div class="nav">
		<div class="codrops-links">
			<div class="logo">
				<a href="/">
					<img src="/images/1fuben.png" alt="公司名称">
				</a>
			</div>
			<nav>
				<ul>
