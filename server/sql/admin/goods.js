...
const editGoodById = (req) => {
  if(req.file) {
    ...
    let sql = `UPDATE goods SET c_id = '${req.body.c_id}',image = '${path}',overView = '${req.body.overView}',advantage = '${req.body.advantage}',content = '${req.body.content}',pageKey = '${req.body.pageKey}',pageDescription = '${req.body.pageDescription}',add_time = NOW(),sort = ${req.body.sort},vidurl = '${req.body.vidurl}' WHERE id = ${req.body.id}`
    return exec(sql);
  } else {
    let sql = `UPDATE goods SET c_id = '${req.body.c_id}',overView = '${req.body.overView}',advantage = '${req.body.advantage}',content = '${req.body.content}',pageKey = '${req.body.pageKey}',pageDescription = '${req.body.pageDescription}',add_time = NOW(),sort = ${req.body.sort},vidurl = '${req.body.vidurl}' WHERE id = ${req.body.id}`
    return exec(sql);
    console
  }
